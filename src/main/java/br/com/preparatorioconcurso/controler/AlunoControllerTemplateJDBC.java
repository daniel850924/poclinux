...
public class AlunoControllerTemplateJDBC {
	...
	public int salvarAluno( @RequestBody Aluno aluno) {
		
		return templateJDBC.salvarAluno(aluno);
	}

	@PutMapping("/atualizarAluno/{codigoAluno}")
	public ResponseEntity<Aluno> atualizarAluno(@PathVariable(value = "codigoAluno") Long codigoAluno, @RequestBody Aluno aluno) throws ResourceNotFoundException {
